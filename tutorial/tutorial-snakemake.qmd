...
ping_result <- system("ping DESKTOP-QLC4OUO  -4", intern = TRUE)

ip_oct <- stringr::str_extract(ping_result, "(?<=desde )(.*?)(?=\\: by)")
ip_oct <- ip_oct[!is.na(ip_oct)][1]

cat("\nLa IP actual de octavio-wsl es:", ip_oct, "\n")
cat("ping DESKTOP-QLC4OUO  -4\n\n")
```
